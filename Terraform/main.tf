...
module "ContainerApp_ResourceGroup" {
    source = "https://github.com/Ajay-Shrivastava/terraform-modules.git/Azure_Resource_Group"
...
module "ContainerApp" {
    ...
    source = "https://github.com/Ajay-Shrivastava/terraform-modules.git/CONTAINER_APP"
