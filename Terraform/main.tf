...
module "ContainerApp_ResourceGroup" {
    source = "https://github.com/Ajay-Shrivastava/terraform-modules/tree/main/Azure_Resource_Group"
...
module "ContainerApp" {
    ...
    source = "https://github.com/Ajay-Shrivastava/terraform-modules/tree/main/Container_App"
